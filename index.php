  ...
  <div class="header-content">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li><a href="#skills" class=""><i class="bi bi-bar-chart navicon"></i> Compétences</a></li>
        <li><a href="#portfolio" class=""><i class="bi bi-images navicon"></i>Mes Projets</a></li>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row skills-content skills-animation">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill"><span>Postgre</span> <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
